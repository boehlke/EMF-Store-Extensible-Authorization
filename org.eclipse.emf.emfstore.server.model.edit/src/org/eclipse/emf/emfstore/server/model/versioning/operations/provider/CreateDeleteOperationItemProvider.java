...
public class CreateDeleteOperationItemProvider extends AbstractOperationItemProvider implements
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 AccesscontrolFactory.eINSTANCE.createRoleAssignment()));
		...
		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createUserManagementOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createOrgUnitOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createDeleteOrgUnitOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createAddGroupMemberOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createProjectOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createAddTagOperation()));
		...
		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createCreateGroupOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createCreateOrUpdateRoleOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createCreateProjectByImportOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createCreateUserOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createCreateVersionOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createDeleteProjectOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createFileDownloadOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createFileUploadOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createReadOrgUnitOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createReadProjectOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createReadPropertiesOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createRemoveGroupMemberOperation()));
		...
		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createWritePropertiesOperation()));

		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createCreateProjectOperation()));
		...
		newChildDescriptors.add
			(createChildParameter
				(OperationsPackage.Literals.CREATE_DELETE_OPERATION__MODEL_ELEMENT,
				 OperationFactory.eINSTANCE.createSetOrgUnitPropertyOperation()));
