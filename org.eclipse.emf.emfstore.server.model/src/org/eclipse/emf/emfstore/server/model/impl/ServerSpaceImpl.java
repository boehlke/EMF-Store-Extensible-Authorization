...
public class ServerSpaceImpl extends EObjectImpl implements ServerSpace {
	...
	public PermissionSet getPermissionSet() {
		if (permissionSet != null && permissionSet.eIsProxy()) {
			...
			if (permissionSet != oldPermissionSet) {
				...
				NotificationChain msgs = oldPermissionSet.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SERVER_SPACE__PERMISSION_SET, null, null);
				if (newPermissionSet.eInternalContainer() == null) {
					msgs = newPermissionSet.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SERVER_SPACE__PERMISSION_SET, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.SERVER_SPACE__PERMISSION_SET, oldPermissionSet, permissionSet));
			}
		}
	...
	public NotificationChain basicSetPermissionSet(PermissionSet newPermissionSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.SERVER_SPACE__PERMISSION_SET, oldPermissionSet, newPermissionSet);
	...
	public void setPermissionSet(PermissionSet newPermissionSet) {
		if (newPermissionSet != permissionSet) {
			...
			if (permissionSet != null)
				msgs = ((InternalEObject)permissionSet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SERVER_SPACE__PERMISSION_SET, null, msgs);
			if (newPermissionSet != null)
				msgs = ((InternalEObject)newPermissionSet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.SERVER_SPACE__PERMISSION_SET, null, msgs);
			msgs = basicSetPermissionSet(newPermissionSet, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SERVER_SPACE__PERMISSION_SET, newPermissionSet, newPermissionSet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.SERVER_SPACE__USERS:
				return getUsers();
			case ModelPackage.SERVER_SPACE__PERMISSION_SET:
				if (resolve) return getPermissionSet();
